        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Welcome to VESlumni, your one-stop platform to reconnect with fellow alumni, discover new opportunities, and build meaningful relationships.',
                style: TextStyle(
                  fontSize: 16.0,
                ),
              ),
              ...
              const Padding(
                ...
                child: Text(
                  'Join us today and experience the power of VESlumni!',
                  style: TextStyle(
                    fontSize: 16.0,
                    fontWeight: FontWeight.bold,
                  ),
